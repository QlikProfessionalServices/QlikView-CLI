...
{
    [Cmdlet(VerbsCommon.Get, "QVRemoteTaskListForDocID")]
    public class GetQVRemoteTaskListForDocID : PSClient
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                Taskinfo = Connection.client.RemoteGetTaskListForDocID(Remoteqmsid, Documentid);
