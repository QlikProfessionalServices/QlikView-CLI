...
{
    [Cmdlet(VerbsCommon.New, "QVDocumentMetaDataServerAccess")]
    public class NewQVDocumentMetaDataServerAccess : PSCmdlet
    {
        private QlikView_CLI.QMSAPI.DocumentMetaData.DocumentMetaDataServer.DocumentMetaDataServerAccess documentmetadataserveraccess;
        [Parameter]
        ...
        {
            base.ProcessRecord();
            documentmetadataserveraccess = new QlikView_CLI.QMSAPI.DocumentMetaData.DocumentMetaDataServer.DocumentMetaDataServerAccess() { DocumentTimeout = Documenttimeout, Download = Download, DownloadUsers = Downloadusers, EnableSessionCollaboration = Enablesessioncollaboration, Export = Export, ExportUsers = Exportusers, MaxConcurrentSessions = Maxconcurrentsessions, Methods = Methods, SessionTimeout = Sessiontimeout, ZeroFootprintClientURL = Zerofootprintclienturl };
        }

        protected override void EndProcessing()
        {
            base.EndProcessing();
            WriteObject(documentmetadataserveraccess);
        }
    }
}
